...
(defconst dd/mu-exe
  (cond (dd/on-m1-p "/opt/homebrew/Cellar/mu/1.6.8/bin/mu")
...
(defconst dd/mu4e-dir
  (cond (dd/on-m1-p "/opt/homebrew/Cellar/mu/1.6.8/share/emacs/site-lisp/mu/mu4e")
        (dd/on-cc7-p "/home/ddavis/software/specific/mu/1.4.15/share/emacs/site-lisp/mu4e")
        (dd/on-mac-p "/usr/local/Cellar/mu/1.6.8/share/emacs/site-lisp/mu/mu4e"))
