...
#+begin_src emacs-lisp :results silent
  ...
  (defconst ddavis-v-llvm-bin
    (cond (ddavis-v-is-mac "/usr/local/opt/llvm/bin")
          (ddavis-v-is-cc7 "~/Software/LLVM/releases/10.x/bin")
          (ddavis-v-is-grads-18 "~/Software/LLVM/releases/10.x/bin")
  ...
  (defconst ddavis-v-mu-exe
    (cond (ddavis-v-is-mac "~/Software/mu/releases/1.4/bin/mu")
  ...
  (defconst ddavis-v-mu4e-dir
    (cond (ddavis-v-is-mac "~/Software/mu/releases/1.4/share/emacs/site-lisp/mu4e")
...
#+begin_src emacs-lisp :results silent
  ...
  (when ddavis-v-is-mac
    ...
    (bind-key (kbd "s-d") #'ddavis/open-init)
