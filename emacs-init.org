...
#+begin_src emacs-lisp :results silent
  ...
  (use-package hydra-posframe
    :load-path "~/.emacs.d/git-repos/hydra-posframe"
    :hook (after-init . hydra-posframe-enable)
    :init
    (setq hydra-posframe-border-width 2)
    :custom-face (hydra-posframe-border-face ((t (:background "gray10"))))
    :custom-face (hydra-posframe-face ((t (:background "gray10")))))
#+end_src
...
#+begin_src emacs-lisp :results silent
  (pretty-hydra-define hydra-projectile (:exit t :hint nil :title (projectile-project-root) :quit-key "q")
    ("Movement" (("b" projectile-switch-to-buffer               "switch")
     ...
     "Search" (("r" ddavis/helm-project-search                  "ripgrep")
...
#+begin_src emacs-lisp :results silent
  (use-package rg
    ...
    :after wgrep
    :config
    (setq rg-executable ddavis-v-rg-exe
          rg-group-result t
          rg-hide-command t)

    (rg-define-search ddavis/grep-vc-or-dir
      :query ask
      :format regexp
      :files "everything"
